...
class Book:
    ...
    def __str__(self):
        return f"Book: {self.author_name} " \
...
class Order:
    ...
    def __str__(self):
        ...
        return f"Order by {self.employee.first_name} " \
               f"{self.employee.last_name} for {self.student.first_name} " \
               f"{self.student.last_name}\n" \
               f"Order date: {self.order_date}\nBooks:\n{book_list}"


# Tworzenie przykładowych obiektów
library1 = Library("City1", "Street1", "12345",
                   "9:00 AM - 5:00 PM", "123-456-789")
library2 = Library("City2", "Street2", "67890",
                   "10:00 AM - 6:00 PM", "987-654-321")

employee1 = Employee("Lukasz", "Kacper", "2023-01-01", "1990-05-15",
                     "City1", "Street1", "12345", "555-111-222")
employee2 = Employee("Daniel", "Martyna", "2023-02-01", "1985-08-20",
                     "City2", "Street2", "67890", "111-222-333")

student1 = Student("Maciek", "Jan")
student2 = Student("Dominik", "Dawid")
student3 = Student("Wiktoria", "Marcin")
