#  pycodestyle --exclude=venv .-*- coding: utf-8 -*-
"""
Spyder Editor
...
# następnie zwróci stringa zgodnie ze
# wzorem Cześć {name} {surname}! Należy
# Operatory arytmetyczne, logiczne i typowanie 3
# uruchomić funkcję, wynik wykonania funkcji
# zapisać do zmiennej, a następnie go
# wyświetlić ( print )
...
# Stworzyć funkcję, która przyjmie 2 argumenty
# typu int , a następnie zwróci wynik
# mnożenia obu liczb.
...
# Stworzyć funkcję, która będzie
# sprawdzała czy przekazana liczba w parametrze jest
# parzysta i zwróci tą informację jako typ
# logiczny bool ( True / False ). Należy
# uruchomić funkcję, wynik wykonania zapisać
# do zmiennej, a następnie
# wykorzystując warunek logiczny wyświetlić
# prawidłowy tekst "Liczba parzysta" /
# "Liczba nieparzysta"
...
# Stworzyć funkcję, która przyjmie 3 argumenty typu
# int i sprawdzi czy suma dwóch
# pierwszych liczb jest większa lub równa trzeciej, a
# następnie zwróci tę informację
...
# Stworzyć funkcję, która przyjmie 2 argumenty.
# Pierwszy typu list , a drugi typu int
# Funkcja ma sprawdzić (zwracając typ logiczny bool ),
# czy lista z parametru
# pierwszego zawiera taką wartość jaką
# przekazano w parametrze drugim.
